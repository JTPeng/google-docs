...
export const Ruler = () => {
  ...
  return (
    <div
      ...
      className="w-[816px] max-auto h-6 border-b border-gray-300 flex items-end relative select-none print:hidden"
    >
...
const Marker = ({
  ...
  return (
    ...
    >
      <FaCaretDown className="absolute left-1/2 top-0 f-full fill-blue-500 transform -translate-x-1/2" />
      <div
